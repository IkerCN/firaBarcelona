    ...
    <div class="menu-principal container">
        <nav class="navbar navbar-expand-lg bg-white">
            <div class="container-fluid">
              <a class="navbar-brand" href="ikercandalija.bernat2024.es"><img src="assets\images\logo-fira-blue.png" alt="logo de la web fira de barcelona"></a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="ikercandalija.bernat2024.es">Home</a>
                  </li>
                  <li class="nav-item">

  ...
  <div class="row">
    ...
    <div class="col-lg-4">
      <div class="mb-5" >
        ...
        <form action="<?=URL ."?controller=producto&action=mostrarPedidos"?>" method="post" class="mt-2">
            <button type="submit" class="btn btn-primary mt-2"> MIS PEDIDOS </button>
          </form>
        <form action="<?=URL ."?controller=producto&action=resenas"?>" method="post" class="mt-2">
